...
import { nonTerminals, terminals } from "./genetics.mjs";
import { coinflip } from './utils.mjs';
...
export class Node {
    ...
    subtreeMutation(initialCoef, coefIncrease) {
        ...
        if (Math.random() <= initialCoef || this.depth <= 1) {
            ...
            this.children[mutationIndex] = this.children[mutationIndex].subtreeMutation(initialCoef + coefIncrease, 1.5 / this.depth);
    ...
    pointMutation(initialCoef, coefIncrease) {
        ...
        if (Math.random() <= initialCoef || this.depth <= 2) {
            ...
            this.children[mutationIndex].pointMutation(initialCoef + coefIncrease, 1.5 / this.depth);
            this.children[mutationIndex] = this.children[mutationIndex].pointMutation(initialCoef + coefIncrease, 1.5 / this.depth);
            this.children[mutationIndex].parent = this;
